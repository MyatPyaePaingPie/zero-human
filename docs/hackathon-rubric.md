...
```json
{
  ...
  "judging": [
    {"id": "judge/autonomy", "title": "An agent runs the company, end to end", "weight": 3, "claims": [
    ...
    {"id": "judge/terac-human-loop", "title": "Real human input via Terac made it measurably better (required rule)", "weight": 3, "claims": [
    ...
    {"id": "judge/revenue", "title": "Real revenue today through Stripe (required for Best Agent-Run Company)", "weight": 3, "claims": [
    ...
    {"id": "judge/viability", "title": "Viable company in 5-10 years", "weight": 2, "claims": [
    ...
    {"id": "judge/impressiveness", "title": "Creativity and technical skill (Best Overall)", "weight": 2, "claims": [
    ...
    {"id": "judge/tracks", "title": "Enters as many tracks as it honestly qualifies for", "weight": 1, "claims": [
  ...
  "sponsors": [
    {"id": "sponsor/terac", "name": "Terac (host, required)", "required": true, "claims": [
    ...
    ], "evidence_hints": ["terac", "app.terac", "TERAC_API_KEY", "terac_create_opportunity", "MCP", "human in the loop"]},
    {"id": "sponsor/stripe", "name": "Stripe (required for payments)", "required": true, "claims": [
    ...
    ], "evidence_hints": ["stripe", "buy.stripe.com", "checkout.stripe.com", "STRIPE_", "payment link", "client_reference_id"]},
    {"id": "sponsor/linq", "name": "Linq (iMessage/RCS/SMS API), $1,500 / $1,000", "required": false, "claims": [
    ...
    ], "evidence_hints": ["linq", "linqapp", "LINQ_API_KEY", "@linqapp/sdk", "iMessage", "api/partner/v3", "webhook-subscriptions"]},
    {"id": "sponsor/replay", "name": "Replay QA, $1,000 / $500", "required": false, "claims": [
    ...
    ], "evidence_hints": ["replay", "qa.replay.io", "loop-qa.replay.io", "REPLAY_API_KEY", "lqa_", "bug report"]},
    {"id": "sponsor/superserve", "name": "Superserve sandboxes, $1,000 / $500", "required": false, "claims": [
    ...
    ], "evidence_hints": ["superserve", "docs.superserve.ai", "SUPERSERVE_API_KEY", "Sandbox.create", "sandbox0"]},
    {"id": "sponsor/pioneer", "name": "Pioneer by Fastino Labs (open-weight models), $500", "required": false, "claims": [
    ...
    ], "evidence_hints": ["pioneer", "fastino", "GLiNER", "GLiGuard", "docs.pioneer.ai", "qwen", "gemma", "llama"]},
    {"id": "sponsor/band", "name": "Band (agent-to-agent coordination), $500", "required": false, "claims": [
    ...
    ], "evidence_hints": ["band", "band.ai", "band-sdk", "@band-ai/sdk", "band_send_message", "band_lookup_peers", "chatroom"]},
    {"id": "sponsor/render", "name": "Render (hosting; Workflows required for the track), $500 / $300 / $100 credits", "required": false, "claims": [
    ...
    ], "evidence_hints": ["render", "onrender.com", "render.yaml", "Render Workflows", "RENDER_API_KEY"]},
    {"id": "sponsor/lovable", "name": "Lovable (credits, no track)", "required": false, "claims": [
    ...
    ], "evidence_hints": ["lovable", "lovable.app", "lovable.dev"]},
    {"id": "sponsor/whop", "name": "Whop (partner, no track)", "required": false, "claims": [
      "The project uses Whop to run or sell part of the business (checkout, memberships, payouts)"
    ], "evidence_hints": ["whop", "api.whop.com"]}
  ],
  "messaging": [
    {"id": "msg/thesis", "theme": "Answers the hackathon's question: can a business run autonomously?", "claims": [
    ...
    {"id": "msg/first-screen", "theme": "A stranger gets it in ten seconds", "claims": [
    ...
    {"id": "msg/proof", "theme": "Shows receipts, not adjectives", "claims": [
    ...
    {"id": "msg/tracks", "theme": "Tells the judges which prizes it is competing for and why it qualifies", "claims": [
    ...
    {"id": "msg/judge-fit", "theme": "Speaks to this panel: YC founders, Stripe Head of AI, a DeepMind PM, growth leads", "claims": [
  ...
  "technical": [
    {"id": "tech/runnable", "title": "A stranger can run and deploy it", "claims": [
    ...
    {"id": "tech/vibe-to-mvp", "title": "From vibe-coded hackathon project to an MVP you can hand users", "claims": [
    ...
    {"id": "tech/marketable", "title": "Ready to put in front of users and market", "claims": [
